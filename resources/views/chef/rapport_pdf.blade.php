...
<head>
    ...
    <style>
        ...
        /* Correction DomPDF : Utilisation de paddings simples et couleurs claires */
        .badge {
            padding: 4px 8px;
            border-radius: 4px;
            font-size: 11px;
...
<body>
    ...
    <div class="header">
        ...
        <div class="subtitle">Rapport Global des Absences Pédagogiques (Généré le {{ now()->format('d/m/Y') }})</div>
    </div>
            ...
            @forelse($classes as $classe)
                <tr>
                    ...
                    <td class="text-center">
                        {{-- Suppression du inline-block problématique pour DomPDF --}}
